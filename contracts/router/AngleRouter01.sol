...
import "../interfaces/governance/IFeeDistributor.sol";
import "../interfaces/governance/ILiquidityGauge.sol";
import "../interfaces/governance/IVeANGLE.sol";
import "../interfaces/coreModule/ISanToken.sol";
import "../interfaces/coreModule/IStableMaster.sol";
import "../interfaces/coreModule/IStableMasterFront.sol";
...
contract AngleRouter is Initializable, ReentrancyGuardUpgradeable {
    ...
    function mixer(
        ...
        RouterActionType[] memory actions,
        bytes[] calldata data
        ...
        for (uint256 i = 0; i < actions.length; i++) {
            if (actions[i] == RouterActionType.claimRewards) {
                (
                    address user,
            ...
            } else if (actions[i] == RouterActionType.claimWeeklyInterest) {
            ...
            } else if (actions[i] == RouterActionType.veANGLEDeposit) {
            ...
            } else if (actions[i] == RouterActionType.gaugeDeposit) {
            ...
            } else if (actions[i] == RouterActionType.deposit) {
                (
                    address user,
                    uint256 amount,
                    bool addressProcessed,
            ...
            } else if (actions[i] == RouterActionType.withdraw) {
                (
                    uint256 amount,
                    bool addressProcessed,
                    address stablecoinOrStableMaster,
            ...
            } else if (actions[i] == RouterActionType.mint) {
                (
                    address user,
                    uint256 amount,
                    uint256 minStableAmount,
            ...
            } else if (actions[i] == RouterActionType.openPerpetual) {
                (
                    address user,
                    uint256 amount,
                    uint256 amountCommitted,
            ...
            } else if (actions[i] == RouterActionType.addToPerpetual) {
                (
                    uint256 amount,
                    uint256 perpetualID,
                    bool addressProcessed,
            ...
            } else if (actions[i] == RouterActionType.borrower) {
                (
                    address collateral,
                    address stablecoin,

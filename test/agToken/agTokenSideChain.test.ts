...
import { AgTokenSideChain, AgTokenSideChain__factory, MockTreasury, MockTreasury__factory } from '../../typechain';
...
contract('AgTokenSideChain', () => {
  ...
  beforeEach(async () => {
    ...
    agToken = (await deployUpgradeable(new AgTokenSideChain__factory(deployer))) as AgTokenSideChain;
  ...
  describe('initializer', () => {
    ...
    it('reverts - wrong treasury address', async () => {
      const agTokenRevert = (await deployUpgradeable(new AgTokenSideChain__factory(deployer))) as AgTokenSideChain;
